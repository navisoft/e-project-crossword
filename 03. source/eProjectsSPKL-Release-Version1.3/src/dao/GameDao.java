...
public class GameDao {
	...
	public static ArrayList<HighScoresModel> getHighScores(String type, String lowerLimit, String upperLimit) {
		...
		try {
			...
			while(resultSet.next()){
				...
				model.setId(resultSet.getString("HIGHSCOREID"));
				model.setPlayerName(resultSet.getString("PLAYERNAME"));
	...
	//update answer4x4 and questions table
	...
	//update answer6x6 and questions table
	...
	//delete scores
	public static boolean deleteHighScore(String scoreID) {
		String sql = "DELETE HIGHSCORES WHERE HIGHSCOREID = ?";
		try {
			PreparedStatement statement = DataUtil.getConnection().prepareStatement(sql);
