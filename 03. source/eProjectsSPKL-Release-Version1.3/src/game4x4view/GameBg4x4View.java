...
public class GameBg4x4View extends JPanel{
	...
	public JLabel lbRow = new JLabel();public JLabel lbColunm = new JLabel();
	public JLabel lbTime = new JLabel(new ImageIcon(getClass().getResource("/images/time.png")));
	...
	private void initComponent() {
		...
		txtAreaRow.setFont(new Font("Arial", 0, 15));
		txtAreaRow.setForeground(Color.blue);txtAreaRow.setEditable(false);
		...
		lbColunm.setText("Column");lbColunm.setFont(new Font("Arial", 0, 20));lbColunm.setForeground(Color.blue);
		...
		txtAreaColunm.setFont(new Font("Arial", 0, 15));
		txtAreaColunm.setForeground(Color.blue);txtAreaColunm.setEditable(false);
	...
	public void mapData(String puzzleID) {
		...
		listAnswer4x4 = GameDao.getData4x4(puzzleID);
		//bon o hang thu nhat
	...
	/////////////////////////////////////////
	//Map data from list into textfield
	/////////////////////////////////////////
		...
		if(listAnswer4x4.get(_locationRow).getValue1().equals("*")){
			...
			_textField.addMouseListener(new MouseListener() {
				public void mouseReleased(MouseEvent e) {
					...
					if(listAnswer4x4.get(_locationRow).getDetail() != null && !listAnswer4x4.get(_locationRow).getDetail().equals("")){
						if(listAnswer4x4.get(_locationRow).getDetail().length()>40){
							txtAreaRow.append(
							listAnswer4x4.get(_locationRow).getDetail().substring(0, 40)+"\n"+
							listAnswer4x4.get(_locationRow).getDetail().substring(40, listAnswer4x4.get(_locationRow).getDetail().length())+
							" ("+checkLengthAnswer(_locationRow)+")");
						}else{
							txtAreaRow.append(listAnswer4x4.get(_locationRow).getDetail()+" ("+checkLengthAnswer(_locationRow)+")");
						}
					}
					if(listAnswer4x4.get(_locationColunm).getDetail() != null && !listAnswer4x4.get(_locationColunm).getDetail().equals("")){
						if(listAnswer4x4.get(_locationColunm).getDetail().length()>40){
							txtAreaColunm.append(
							listAnswer4x4.get(_locationColunm).getDetail().substring(0, 40)+"\n"+
							listAnswer4x4.get(_locationColunm).getDetail().substring(40, listAnswer4x4.get(_locationColunm).getDetail().length())+
