				...
				public void actionPerformed(ActionEvent e) {
					...
					if(panel.btFinish.getToolTipText().equals("Finish")){
						...
						if(result==0){
							...
							panel.txt_0_4.setEnabled(false);
							panel.txt_0_5.setEnabled(false);
							panel.txt_1_0.setEnabled(false);
							panel.txt_1_1.setEnabled(false);
							panel.txt_1_2.setEnabled(false);
							panel.txt_1_3.setEnabled(false);
							panel.txt_1_4.setEnabled(false);
							panel.txt_1_5.setEnabled(false);
							panel.txt_2_0.setEnabled(false);
							panel.txt_2_1.setEnabled(false);
							panel.txt_2_2.setEnabled(false);
							panel.txt_2_3.setEnabled(false);
							panel.txt_2_4.setEnabled(false);
							panel.txt_2_5.setEnabled(false);
							panel.txt_3_0.setEnabled(false);
							panel.txt_3_1.setEnabled(false);
							panel.txt_3_2.setEnabled(false);
							panel.txt_3_3.setEnabled(false);
							panel.txt_3_4.setEnabled(false);
							panel.txt_3_5.setEnabled(false);
							panel.txt_4_0.setEnabled(false);
							panel.txt_4_1.setEnabled(false);
							panel.txt_4_2.setEnabled(false);
							panel.txt_4_3.setEnabled(false);
							panel.txt_4_4.setEnabled(false);
							panel.txt_4_5.setEnabled(false);
							panel.txt_5_0.setEnabled(false);
							panel.txt_5_1.setEnabled(false);
							panel.txt_5_2.setEnabled(false);
							panel.txt_5_3.setEnabled(false);
							panel.txt_5_4.setEnabled(false);
							panel.txt_5_5.setEnabled(false);
							String time;
							...
							while( playerName == null ||  "".equals(playerName)){
								...
								finish.proAnswer.txt_0_0.setText(panel.listAnswer6x6.get(0).getValue1().toUpperCase());
								finish.proAnswer.txt_0_1.setText(panel.listAnswer6x6.get(0).getValue2().toUpperCase());
								finish.proAnswer.txt_0_2.setText(panel.listAnswer6x6.get(0).getValue3().toUpperCase());
								finish.proAnswer.txt_0_3.setText(panel.listAnswer6x6.get(0).getValue4().toUpperCase());
								finish.proAnswer.txt_0_4.setText(panel.listAnswer6x6.get(0).getValue5().toUpperCase());
								finish.proAnswer.txt_0_5.setText(panel.listAnswer6x6.get(0).getValue6().toUpperCase());		
								
								finish.proAnswer.txt_1_0.setText(panel.listAnswer6x6.get(1).getValue1().toUpperCase());
								finish.proAnswer.txt_1_1.setText(panel.listAnswer6x6.get(1).getValue2().toUpperCase());
								finish.proAnswer.txt_1_2.setText(panel.listAnswer6x6.get(1).getValue3().toUpperCase());
								finish.proAnswer.txt_1_3.setText(panel.listAnswer6x6.get(1).getValue4().toUpperCase());	
								finish.proAnswer.txt_1_4.setText(panel.listAnswer6x6.get(1).getValue5().toUpperCase());
								finish.proAnswer.txt_1_5.setText(panel.listAnswer6x6.get(1).getValue6().toUpperCase());

								finish.proAnswer.txt_2_0.setText(panel.listAnswer6x6.get(2).getValue1().toUpperCase());
								finish.proAnswer.txt_2_1.setText(panel.listAnswer6x6.get(2).getValue2().toUpperCase());
								finish.proAnswer.txt_2_2.setText(panel.listAnswer6x6.get(2).getValue3().toUpperCase());
								finish.proAnswer.txt_2_3.setText(panel.listAnswer6x6.get(2).getValue4().toUpperCase());
								finish.proAnswer.txt_2_4.setText(panel.listAnswer6x6.get(2).getValue5().toUpperCase());
								finish.proAnswer.txt_2_5.setText(panel.listAnswer6x6.get(2).getValue6().toUpperCase());	

								finish.proAnswer.txt_3_0.setText(panel.listAnswer6x6.get(3).getValue1().toUpperCase());
								finish.proAnswer.txt_3_1.setText(panel.listAnswer6x6.get(3).getValue2().toUpperCase());
								finish.proAnswer.txt_3_2.setText(panel.listAnswer6x6.get(3).getValue3().toUpperCase());
								finish.proAnswer.txt_3_3.setText(panel.listAnswer6x6.get(3).getValue4().toUpperCase());
								finish.proAnswer.txt_3_4.setText(panel.listAnswer6x6.get(3).getValue5().toUpperCase());
								finish.proAnswer.txt_3_5.setText(panel.listAnswer6x6.get(3).getValue6().toUpperCase());

								finish.proAnswer.txt_4_0.setText(panel.listAnswer6x6.get(4).getValue1().toUpperCase());
								finish.proAnswer.txt_4_1.setText(panel.listAnswer6x6.get(4).getValue2().toUpperCase());
								finish.proAnswer.txt_4_2.setText(panel.listAnswer6x6.get(4).getValue3().toUpperCase());
								finish.proAnswer.txt_4_3.setText(panel.listAnswer6x6.get(4).getValue4().toUpperCase());
								finish.proAnswer.txt_4_4.setText(panel.listAnswer6x6.get(4).getValue5().toUpperCase());
								finish.proAnswer.txt_4_5.setText(panel.listAnswer6x6.get(4).getValue6().toUpperCase());	

								finish.proAnswer.txt_5_0.setText(panel.listAnswer6x6.get(5).getValue1().toUpperCase());
								finish.proAnswer.txt_5_1.setText(panel.listAnswer6x6.get(5).getValue2().toUpperCase());
								finish.proAnswer.txt_5_2.setText(panel.listAnswer6x6.get(5).getValue3().toUpperCase());
								finish.proAnswer.txt_5_3.setText(panel.listAnswer6x6.get(5).getValue4().toUpperCase());
								finish.proAnswer.txt_5_4.setText(panel.listAnswer6x6.get(5).getValue5().toUpperCase());
								finish.proAnswer.txt_5_5.setText(panel.listAnswer6x6.get(5).getValue6().toUpperCase());	
