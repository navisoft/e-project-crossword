...
public class PanelGameMainView extends JPanel{
	...
	private void initComponent() {
		...
		btPlayGame.setIcon(new ImageIcon(getClass().getResource("/images/play.png")));
		...
		btManageGame.setIcon(new ImageIcon(getClass().getResource("/images/manage.png")));
		...
		btHighScores.setIcon(new ImageIcon(getClass().getResource("/images/high_scores.png")));
		...
		btHelp.setIcon(new ImageIcon(getClass().getResource("/images/help.png")));
		...
		btQuit.setIcon(new ImageIcon(getClass().getResource("/images/quit.png")));
