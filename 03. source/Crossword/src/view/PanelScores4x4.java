...
public class PanelScores4x4 extends JPanel{
	/**
	 * 
	 */
	...
	public PanelScores4x4(Image _img,int _width,int _height) {
		try {
	...
	private void initComponent() {
		...
		listHighScore = GameDao.getHighScores4x4();
		...
		bt6x6.setIcon(new ImageIcon("src/view/images/6x6.png"));
		bt6x6.setPreferredSize(new Dimension(100, 30));bt6x6.addMouseListener(new MouseListener() {
			@Override
			...
			public void mouseEntered(MouseEvent arg0) {
				bt6x6.setIcon(new ImageIcon("src/view/images/6x6_hover.png"));
