...
public class GameBg4x4View extends JPanel{
	...
	public JLabel lbTime = new JLabel(new ImageIcon("src/view/images/time.png"));
	...
	private void initComponent() {
		...
		btNewGame.setIcon(new ImageIcon("src/view/images/generate.png"));
		...
		btFinish.setIcon(new ImageIcon("src/view/images/submit.png"));
