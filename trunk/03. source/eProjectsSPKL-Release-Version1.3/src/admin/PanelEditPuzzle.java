...
public class PanelEditPuzzle extends JPanel{
	...
	private void initComponent() {
		...
		btEdit.setText("Edit");
		btEdit.setIcon(new ImageIcon(getClass().getResource("/images/edit_puzzle.png")));
		...
		btDelete.setIcon(new ImageIcon(getClass().getResource("/images/delete.png")));
		...
		btUpdate.setIcon(new ImageIcon(getClass().getResource("/images/update.png")));
