...
public class PanelCreatePuzzle6x6 extends JPanel{
	...
	public PanelCreatePuzzle6x6() {
		...
		btNew.setPreferredSize(new Dimension(130, 50));
		btNew.setIcon(new ImageIcon(getClass().getResource("/images/generate.png")));
		btNew.setToolTipText("New");
		pnButton.add(btNew,bagConstraints);
		
		bagConstraints.gridx = 1;
		bagConstraints.gridy = 0;
		bagConstraints.gridwidth = 1;
		bagConstraints.insets = new Insets(0, 0, 0, 0);
		btSavePuzzle.setPreferredSize(new Dimension(130, 50));
		btSavePuzzle.setIcon(new ImageIcon(getClass().getResource("/images/save.png")));
		...
		bagConstraints.gridwidth = 1;
		bagConstraints.insets = new Insets(0, 0, 0, 0);
		btEmpty.setPreferredSize(new Dimension(130, 50));
		btEmpty.setIcon(new ImageIcon(getClass().getResource("/images/clear.png")));
