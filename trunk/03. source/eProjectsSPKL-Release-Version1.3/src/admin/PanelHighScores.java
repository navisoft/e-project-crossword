...
public class PanelHighScores extends JPanel{
	...
	public JMenuItem itemPopupDelete = new JMenuItem();
	...
	public void getDataHighScores(String type, String lowerLimit, String upperLimit) {
		...
		for (HighScoresModel model : listHighScores) {
			i++;
			dataHighScores[row][0] = model.getId();
	...
	public void getTableHighScores() {
		itemPopupDelete.setText("Delete");
		itemPopupDelete.setPreferredSize(new Dimension(100, 30));
		popupMenu.add(itemPopupDelete);
		tbHighScores.add(popupMenu);
		tbHighScores = new JTable(dataHighScores,columnNameHighScores);
		tbHighScores.setRowHeight(25);
		//Show delete score menu
		tbHighScores.addMouseListener(new MouseListener() {
			@Override
