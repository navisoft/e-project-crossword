...
public class PanelFinish6x6 extends JPanel{
	...
	public PanelDisplayAnswer6x6 proAnswer;
	public PanelDisplayAnswer6x6 youAnswer;
	...
	public PanelFinish6x6(Image _img,int _width,int _height) {
		try {
			this.img = _img;
			this.width = _width;
			this.height = _height;
	...
	private void initComponent() {
		...
		pnResults.setPreferredSize(new Dimension(710, 90));
		...
		constraints.gridwidth = 1;
		constraints.insets = new Insets(0, 0, 0, 0);
		pnAnswers.setPreferredSize(new Dimension(620, 300));
		...
		proAnswer = new PanelDisplayAnswer6x6();
		...
		youAnswer = new PanelDisplayAnswer6x6();
		...
		constraints.gridwidth = 1;
		constraints.insets = new Insets(0, 0, 0, 0);
		pnButton.setPreferredSize(new Dimension(710, 90));
		...
		btHighScores.setIcon(new ImageIcon(getClass().getResource("/images/high_scores_player.png")));
		...
		btQuit.setIcon(new ImageIcon(getClass().getResource("/images/quit30.png")));
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("P", 20, 131);
		g.setFont(new Font("Arial", 1, 27));
		g.drawString("R", 19, 168);
		g.setFont(new Font("Arial", 1, 29));
		g.drawString("O", 18, 207);
		g.setFont(new Font("Arial", 1, 31));
		g.drawString("G", 17, 247);
		g.setFont(new Font("Arial", 1, 33));
		g.drawString("R", 16, 286);
		g.setFont(new Font("Arial", 1, 35));
		g.drawString("A", 15, 330);
		g.setFont(new Font("Arial", 1, 37));
		g.drawString("M", 14, 377);
		
		g.setFont(new Font("Arial", 1, 27));
		g.drawString("Y", 705, 168);
		g.setFont(new Font("Arial", 1, 31));
		g.drawString("O", 703, 247);
		g.setFont(new Font("Arial", 1, 35));
		g.drawString("U", 701, 330);
	}
}
